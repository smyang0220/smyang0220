...
<h3>👋🏻 안녕하세요! 빠르게 성장하는 모바일 앱 개발자 양희태입니다.</h3>
항상 **최신 기술에 관심**을 가지고, 이를 프로젝트에 적용해보며 **흥미를 느낍니다.**
최근에는 **코드 제네레이션**, **객체 지향 개발**에 대하여 흥미를 느끼고 있습니다.

**새로운 것을 익히고 적용하는데에 있어 두려움을 가지지 않는 것이 제 장점**이라고 생각합니다.
또한, **원하는 결과가 눈에 보일 때까지 삽질하고 매달리는 끈기와 열정**또한 **누구보다 자신**있습니다.

**배움보다도 프로젝트에 적용하는 능력이 진짜 제 지식**이라고 생각하여, **꾸준히 프로젝트 코드 리펙토링을 진행하고 있습니다.**
<br>
